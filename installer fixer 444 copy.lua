return (function(ria) 
	...
	installbutton.MouseButton1Click:Connect(function()
		...
		for i,v in next, taskfunctions do 
			...
			pcall(function() tweenService:Create(progressbar2, TweenInfo.new(0.3, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, 0, true, 0), {Size = UDim2.new(0.2, offset, 0, 45)}):Play() end)
			tasknum = (tasknum - 1)
		end 
