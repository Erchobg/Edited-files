local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		local suc, res = pcall(function() return requests("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/".Body..readfile("vape/commithash.txt").."/"..scripturl, true) end)
